...
export default function ListingDetail() {
  ...
  if (loading) {
    return <div className="text-center text-xl mt-20 font-semibold text-gray-600">Loading details...</div>;
  }

  if (!listing) {
    return <div className="text-center text-xl mt-20 text-red-500">Experience not found.</div>;
  }
    ...
    <div className="container mx-auto p-6 mt-8 max-w-4xl">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div className="p-8">
          ...
          <p className="text-gray-500 text-lg mb-6 font-medium flex items-center gap-2">
            📍 {listing.location}
          </p>
